...
def display(tfrecord_dir, image_size, num_images=5):
    ...
    idx = 0
    filename = '/opt/project/output/verify_dataset/supervised-ffhq/20200721/image_batch_{0}_indx_{1}.jpg'
...
if __name__ == '__main__':
    ...
    tfrecord_dir = '/opt/data/face-fuse/supervised_ffhq/test/'
    image_size = 224
    num_images = 16
    display(tfrecord_dir, image_size, num_images=num_images)