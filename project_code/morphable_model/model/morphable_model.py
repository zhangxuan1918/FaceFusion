...
class FFTfMorphableModel(TfMorphableModel):
    ...
    def __init__(self, param_mean_var_path, *args, **kwargs):
    ...
    def load_param_mean_var(self):
        ...
        self.pose_mu = tf.constant(params_mean_var['Pose_Param_mean'], dtype=tf.float32)
        self.pose_std = tf.constant(params_mean_var['Pose_Param_mean'], dtype=tf.float32)
