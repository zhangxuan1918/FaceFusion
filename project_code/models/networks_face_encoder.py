...
class FaceEncoder:
    def __init__(self, image_size, gf_dim, gfc_dim, sh_dim, tx_dim, co_dim, m_dim, il_dim):
    ...
    def get_encoder(self, inputs, is_reuse=False, is_training=True):
        ...
        # Pose
        k51_m = self.g_bn5_m(Conv2D(int(self.gfc_dim / 5), (3, 3), (1, 1), padding='SAME', use_bias=False, name='g_k5_m_conv')(k4_1), training=is_training)
        ...
        # Illumination
        k51_ill = self.g_bn5_ill(Conv2D(int(self.gfc_dim / 5), (3, 3), (1, 1), padding='SAME', name='g_k5_il_conv')(k4_1), training=is_training)
        ...
        # Shape
        k51_shape = self.g_bn5_shape(Conv2D(int(self.gfc_dim / 2), (3, 3), (1, 1), padding='SAME', name='g_k5_shape_conv')(k4_1), training=is_training)
        ...
        k6_shape = Dense(self.sh_dim, name='g_k6_sh_lin')(k52_shape)

        # Texture
        k51_tex = self.g_bn5_tex(Conv2D(int(self.gfc_dim / 2), (3, 3), (1, 1), padding='SAME', name='g_k5_tex_conv')(k4_1), training=is_training)
        ...
        k6_tex = Dense(self.tx_dim, name='g_k6_tex_lin')(k52_tex)

        # Expression
        k51_exp = self.g_bn5_exp(Conv2D(int(self.gfc_dim / 5), (3, 3), (1, 1), padding='SAME', name='g_k5_exp_conv')(k4_1), training=is_training)
        ...
        k6_exp = Dense(self.sh_dim, name='g_k6_exp_lin')(k52_exp)

        # Color
        k51_col = self.g_bn5_col(Conv2D(int(self.gfc_dim / 5), (3, 3), (1, 1), padding='SAME', name='g_k5_col_conv')(k4_1), training=is_training)
