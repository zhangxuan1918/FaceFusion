...
predictor = dlib.shape_predictor('/opt/data/dlib/shape_predictor_68_face_landmarks.dat')
...
def align_face(filepath, output_size=224, transform_size=4096, enable_padding=True):
    """
    :param filepath: str
    :return: PIL Image
    """
